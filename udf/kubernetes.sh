...
if [[ $1 = "kubeconfig" ]]; then
  ...
  ssh master2 "mkdir -p ${HOME_DIR}/.kube ; sudo cp /etc/kubernetes/admin.conf ${HOME_DIR}/.kube/config ; chmod -R 600 ${HOME_DIR}/.kube ; chown -R ubuntu:ubuntu ${HOME_DIR}/.kube"
  ...
  ssh master3 "mkdir -p ${HOME_DIR}/.kube ; sudo cp /etc/kubernetes/admin.conf ${HOME_DIR}/.kube/config ; chmod -R 600 ${HOME_DIR}/.kube ; chown -R ubuntu:ubuntu ${HOME_DIR}/.kube"
