...
argocd login 10.1.1.100:443 --username admin --password admin
argocd repo add git@gogs.aspendemo.org:aspenmesh/argocd.git --ssh-private-key-path ~/.ssh/id_rsa --insecure-ignore-host-key
